...
const Register = ({ children }) => {
  ...
  const handleRegister = (e) => {
    ...
    if (password.length < 6) {
      ...
      setSignUpError("password must be contain speical char");
      return;
    }
    //   create user
  ...
  return (
    <div className="flex justify-center items-center h-screen my-12">
      <div className="relative flex flex-col rounded-xl bg-transparent bg-clip-border text-gray-700 shadow p-12">
